...
export var GroupInfoService = (function () {
    ...
    Object.defineProperty(GroupInfoService.prototype, "columns", {
        get: function () {
            var lockedColumns = this._columnsContainer.lockedColumns;
            var columns = this._columnsContainer.nonLockedColumns;
            return lockedColumns.toArray().concat(columns.toArray());
        },
        enumerable: true,
        configurable: true
    });
