...
/**
 * Represents the column group footer cell template of the Kendo UI Grid which helps to customize the group footer cell for the column.
 *
 * To define the group footer template, nest a `<template>` tag with the `kendoGroupFooterTemplate` directive inside `<kendo-grid-column>`.
 *
 ...
 *                 <template kendoGroupFooterTemplate let-aggregates let-field="field">
