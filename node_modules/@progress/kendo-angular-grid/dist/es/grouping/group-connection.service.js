...
var isOutside = function (target, _a) {
    ...
    return !(pageX > dimensions.left && pageX < dimensions.right && pageY > dimensions.top && pageY < dimensions.bottom);
};
...
export var GroupConnectionService = (function () {
    ...
    /** @nocollapse */
    GroupConnectionService.ctorParameters = [];
...
var createHint = function (column) {
    ...
    return {
        ...
        remove: function () { return document.body.removeChild(hint); }
    };
};
/**
 * @hidden
...
export var GroupDragService = (function () {
        ...
        this.ngzone.runOutsideAngular(function () {
            ...
            _this.subscriptions = draggables.map(function (draggable) {
                ...
                return presses
                    ...
                    .switchMap(function (hint) { return releases.take(1).do(function () {
                    hint.remove();
    ...
    /** @nocollapse */
    GroupDragService.ctorParameters = [
