...
var GroupPanelComponent = (function () {
    function GroupPanelComponent(connection, draggableService, element) {
        var _this = this;
    ...
    Object.defineProperty(GroupPanelComponent.prototype, "text", {
        get: function () {
            return this.emptyText ? this.emptyText : "Drag a column header and drop it here to group by that column";
        },
        set: function (value) {
