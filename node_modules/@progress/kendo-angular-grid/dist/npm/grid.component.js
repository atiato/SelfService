...
var GridComponent = (function () {
    function GridComponent(supportService, selectionService, wrapper, groupInfoService, groupsService, changeNotification) {
        var _this = this;
         ...
         * It is required by the [paging functionality]({% slug overview_grid_kendouiforangular %}#toc-paging).
         */
        this.skip = 0;
        /**
         ...
         * Emits the [`SelectionEvent`]({% slug api_grid_selectionevent_kendouiforangular %}#toc-selectionchange-eventemitter).
         */
    ...
    Object.defineProperty(GridComponent.prototype, "isLocked", {
         ...
         */
        get: function () {
            return this.lockedColumns.length > 0;
        },
        enumerable: true,
        configurable: true
    });
     ...
     *
     * @param {string} index underscore separated heirarical index of the group
     */
    ...
    GridComponent.propDecorators = {
        ...
        'columns': [{ type: core_1.ContentChildren, args: [column_component_1.ColumnComponent,] },],
