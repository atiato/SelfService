...
(function(factory) {
  ...
  function Submenupicker(element) {
    ...
    this.$main = this.$element.parent();
    this.$menu = this.$main.children('.dropdown-menu');
    //this.$menu = this.$main.children('menuitem2').children('.dropdown-menu');
    this.$items = this.$menu.children('.dropdown-submenu');
  ...
  Submenupicker.prototype = {
    init: function() {
      ...
      this.$menu.on('keydown',
          $.proxy(this, 'itemKeydown')
          );
      ...
      this.$main.on('hidden.bs.dropdown',
          $.proxy(this, 'hidden')
          );
    },
    hidden: function() {
